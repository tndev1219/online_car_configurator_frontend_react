...
(function (win, doc, NS) {
    ...
    (function ($) {
        ...
        self.innerHTML = '<div class="color-picker-container"><span class="color-picker-h"><i></i></span><span class="color-picker-sv"><i></i></span><div class="form-check bg-activated"><label class="form-check-label"><input type="checkbox" class="form-check-input bg-color-active" ><span>Activated</span></label></div></div>';
        ...
        $.fit = function (o) {
            ...
            self.style.left = (left - 75) + 'px';
            self.style.top = (top - 105) + 'px';
            return trigger("fit"), $;
        };
